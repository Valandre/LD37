class MaterialDatabase {
	...
	function getPath( material : h3d.mat.Material, setup : h3d.mat.MaterialSetup ) {
	...
	public function loadProps( material : h3d.mat.Material, setup : h3d.mat.MaterialSetup ) {
		if( db == null ) load();
	...
	public function saveProps( material : h3d.mat.Material, setup : h3d.mat.MaterialSetup ) {
		if( db == null ) load();
		var path = getPath(material, setup);
		var root : Dynamic = db;
		var prevs = [];
